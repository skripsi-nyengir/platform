...
* **live:** preserve durable boundary anchors in database ingress order ([9bd6c04](https://github.com/skripsi-nyengir/platform/commit/9bd6c04db7cad979daa059586dc7e5e11a77da98))
...
* **auth:** add users and user_sessions schema ([4c066a5](https://github.com/skripsi-nyengir/platform/commit/4c066a546e312162e209b909c122cfaaaae927e9))
* **auth:** add password hashing, session service, and account CLI ([b319ec8](https://github.com/skripsi-nyengir/platform/commit/b319ec8d7c585654439207b36cdc0af1fa698128))
* **auth:** close every route behind a fail-closed session guard ([f913ef9](https://github.com/skripsi-nyengir/platform/commit/f913ef9aaf4a06c094516c11a07b51022c39d579))
* **auth:** add the login page and route guard ([0159e99](https://github.com/skripsi-nyengir/platform/commit/0159e99d50dc4fb3ec7681cc69bfb4a3a18c96c7))
* **auth:** keep deployment verification working behind the guard ([95815e3](https://github.com/skripsi-nyengir/platform/commit/95815e3e3ffab2ea955a52a28cf09f47b90bcb09))
* **notifier:** post alert episodes to Slack with charts ([d793bbd](https://github.com/skripsi-nyengir/platform/commit/d793bbd5c024efe9a489d2777f753b044dc77de5))


### Bug Fixes

* **ci:** give pyright the notifier dependencies and satisfy shellcheck ([913be6c](https://github.com/skripsi-nyengir/platform/commit/913be6c8e50086fb811dcac58ac24f7fba947db4))
* **ci:** respect organization release policy ([49d7ecd](https://github.com/skripsi-nyengir/platform/commit/49d7ecdb5bd2269ea55c5bc81abeaea7ae2eb95b))
